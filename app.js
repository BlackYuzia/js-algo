function writeAlgoDemo1() {
    ...
    document.write("Side a=" + side_a + "</p><p>Side b=" + side_b + "</p>");
    document.write("<p>Объем куба " + side_a * side_a * side_a + "</p>");
    document.write("<p>Площадь квадрата " + side_a * side_b + "</p>");
...
function writeAlgoDemo2() {
    ...
    document.write("<p> Площадь прямоугольного треугольника " + side_b * side_b / 2 + "</p>");
}
